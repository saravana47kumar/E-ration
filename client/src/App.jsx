...
import { RationCardProvider } from './context/RationCardContext';
...
import RationCardAdmin   from './pages/admin/RationCardAdmin';
import DocumentVerificationAdmin from './pages/admin/DocumentVerificationAdmin';
...
import RationCardPage    from './pages/customer/RationCardPage';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/admin/ration-cards" element={<ProtectedRoute role="admin"><RationCardAdmin /></ProtectedRoute>} />
        <Route path="/admin/documents"    element={<ProtectedRoute role="admin"><DocumentVerificationAdmin /></ProtectedRoute>} />
        ...
        <Route path="/customer/ration-card"     element={<ProtectedRoute role="customer"><RationCardProvider><RationCardPage /></RationCardProvider></ProtectedRoute>} />
        <Route path="/customer/documents"       element={<ProtectedRoute role="customer"><DocumentsPage /></ProtectedRoute>} />
