...
// Modify login function to track login
...
const logout = async (req, res) => {
  try {
    ...
    await LoginHistory.findOneAndUpdate(
      { user: req.user._id, logoutAt: null },
      { logoutAt: new Date() },
      { sort: { loginAt: -1 } }
    );
...
module.exports = { register, login, getMe, updateProfile, uploadProfileImage, changePassword, logout, getLoginHistory };